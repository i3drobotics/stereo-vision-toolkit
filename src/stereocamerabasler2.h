...
#ifndef STEREOCAMERABASLER2_H
#define STEREOCAMERABASLER2_H
...
class StereoCameraBasler2 : public AbstractStereoCamera
{
Q_OBJECT

public:
    explicit StereoCameraBasler2(QObject *parent = 0) :
