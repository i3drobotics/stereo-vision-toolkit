...
PylonSetProperty( int propertyId, const void* pData, size_t size );

PYLONC_API GENAPIC_RESULT PYLONC_CC
PylonGetProperty( int propertyId, void* pData, size_t* pSize );
...
IDL_ENTRY(PYLONC_MODULE, "_PylonEnumerateInterfaces@4", "Enumerate all interfaces.")
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonEnumerateInterfaces(RETVAL_PAR size_t *numInterfaces);

/* Interface enumeration */
IDL_ENTRY(PYLONC_MODULE, "_PylonEnumerateInterfacesByDeviceClass@8", "Enumerate all interfaces for a given deviceclass.")
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonEnumerateInterfacesByDeviceClass(const char* pDeviceClass, RETVAL_PAR size_t *numInterfaces);

/* Interface information */
IDL_ENTRY(PYLONC_MODULE, "_PylonGetInterfaceInfo@8", "Get Information about an interface identified by its index.")
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE_DOC
PylonGetInterfaceInfo(size_t index, RETVAL_PAR PylonInterfaceInfo_t *pIfInfo);

/* Interface creation */
IDL_ENTRY(PYLONC_MODULE, "_PylonCreateInterfaceByIndex@8", "Create interface by index.")
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonCreateInterfaceByIndex(size_t index, RETVAL_PAR PYLON_INTERFACE_HANDLE *phIf);

/* Interface destruction */
IDL_ENTRY(PYLONC_MODULE, "_PylonDestroyInterface@4", "Destroys an interface.")
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonDestroyInterface(PYLON_INTERFACE_HANDLE hIf);

/* Interface open */
IDL_ENTRY(PYLONC_MODULE, "_PylonInterfaceOpen@4", "Opens an interface.")
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonInterfaceOpen(PYLON_INTERFACE_HANDLE hIf);

/* Interface close */
IDL_ENTRY(PYLONC_MODULE, "_PylonInterfaceClose@4", "Closes an interface.")
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonInterfaceClose(PYLON_INTERFACE_HANDLE hIf);

/* Interface IsOpen */
IDL_ENTRY(PYLONC_MODULE, "_PylonInterfaceIsOpen@8", "Checks if an interface is open.")
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonInterfaceIsOpen(PYLON_INTERFACE_HANDLE hIf, _Bool * pOpen);

/* Interface info */
IDL_ENTRY(PYLONC_MODULE, "_PylonInterfaceGetInterfaceInfo@8", "Returns the interface info.")
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE_DOC
PylonInterfaceGetInterfaceInfo(PYLON_INTERFACE_HANDLE hIf, RETVAL_PAR PylonInterfaceInfo_t *pIfInfo);

/* Interface nodemap  */
IDL_ENTRY(PYLONC_MODULE, "_PylonInterfaceGetNodeMap@8", "Returns the interface nodemap.")
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonInterfaceGetNodeMap(PYLON_INTERFACE_HANDLE hIf, RETVAL_PAR NODEMAP_HANDLE *phMap);
...
IDL_ENTRY( PYLONC_MODULE, "_PylonStreamGrabberGetPayloadSize@12", "Return the current payload size in bytes" )
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonStreamGrabberGetPayloadSize( PYLON_DEVICE_HANDLE hDev, PYLON_STREAMGRABBER_HANDLE hStg, size_t* payloadsize );
...
IDL_ENTRY(PYLONC_MODULE, "_PylonStreamGrabberIsStartAndStopStreamingMandatory@8", "Checks if Start/StopStreamingIfMandatory is required.")
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonStreamGrabberIsStartAndStopStreamingMandatory(PYLON_STREAMGRABBER_HANDLE hStg, _Bool * pMandatory);

IDL_ENTRY(PYLONC_MODULE, "_PylonStreamGrabberStartStreamingIfMandatory@4", "Start streaming.")
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonStreamGrabberStartStreamingIfMandatory(PYLON_STREAMGRABBER_HANDLE hStg);

IDL_ENTRY(PYLONC_MODULE, "_PylonStreamGrabberStopStreamingIfMandatory@4", "Stop streaming.")
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonStreamGrabberStopStreamingIfMandatory(PYLON_STREAMGRABBER_HANDLE hStg);
...
IDL_ENTRY(PYLONC_MODULE, "_PylonStreamGrabberFlushBuffersToOutput@4", "Cancel grab operation.")
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE
PylonStreamGrabberFlushBuffersToOutput(PYLON_STREAMGRABBER_HANDLE hStg);
