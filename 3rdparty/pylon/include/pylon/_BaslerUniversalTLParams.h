...
namespace Basler_UniversalTLParams
{
    ...
    {
        DeviceAccessStatus_Busy,  //!< The device is already opened by another entity - Applies to: CoaXPress
        DeviceAccessStatus_NoAccess,  //!< You can't connect to the device - Applies to: CoaXPress
        DeviceAccessStatus_OpenReadOnly,  //!< The device is opened in Read-only mode by this GenTL host - Applies to: CoaXPress
        DeviceAccessStatus_OpenReadWrite,  //!< The device is opened in Read/Write mode by this GenTL host - Applies to: CoaXPress
        DeviceAccessStatus_ReadOnly,  //!< The device offers read-only access - Applies to: CoaXPress
        DeviceAccessStatus_ReadWrite,  //!< The device offers read/write access - Applies to: CoaXPress
        DeviceAccessStatus_Unknown  //!< The status is unknown - Applies to: CoaXPress
    };
    ...
    {
        EventNotification_Off,  //!< The selected Event notification is disabled - Applies to: CoaXPress
        EventNotification_On,  //!< The selected Event notification is enabled - Applies to: CoaXPress
        EventNotification_Once  //!< The selected Event notification is enabled for one event then return to Off state - Applies to: CoaXPress
    };

    //! Valid values for EventSelector
    enum EventSelectorEnums
    {
        EventSelector_DeviceLost  //!< Selects the Device Lost Event - Applies to: CoaXPress
    };
    ...
    //**************************************************************************************************
    // Parameter class CUniversalTLParams_Params_v6_1_0
    //**************************************************************************************************
    ...
    The \ref sample_ParametrizeCamera_NativeParameterAccess code sample shows how to access camera parameters via the \c Pylon::CBaslerUniversalInstantCamera class.
    */
    class PYLONBASE_API CUniversalTLParams_Params_v6_1_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        //! \cond HIDE_CLASS_METHODS
            ...
            //! Constructor
            CUniversalTLParams_Params_v6_1_0(void);
    ...
    private:
        class CUniversalTLParams_Params_v6_1_0_Data;
        CUniversalTLParams_Params_v6_1_0_Data* m_pCUniversalTLParams_Params_v6_1_0_Data;
    ...
    */
    ...
    //@{
    /*!
        \brief Returns the device's access status at the moment when the Device Update List command was last executed - Applies to: CoaXPress
    ...
    */
    ...
    //@{
    /*!
        \brief User-friendly name of the device - Applies to: CoaXPress
    ...
    */
    ...
    //@{
    /*!
        \brief Interface-wide unique ID of the selected device - Applies to: CoaXPress
    ...
    */
    ...
    //@{
    /*!
        \brief Name of the device model - Applies to: CoaXPress
    ...
    */
    ...
    //@{
    /*!
        \brief Name of the device vendor - Applies to: CoaXPress
    ...
    */
    ...
    //@{
    /*!
        \brief Returns the unique Identifier of the Device Lost type of Event - Applies to: CoaXPress
    ...
    */
    ...
    //@{
    /*!
        \brief Activate or deactivate the notification to the host application of the occurrence of the selected Event - Applies to: CoaXPress
    ...
    */
    ...
    //@{
    /*!
        \brief Selects which Event to signal to the host application - Applies to: CoaXPress
    ...
    */
    ...
    //@{
    /*!
        \brief Sets the stream channel - Applies to: CoaXPress
    ...
    */
    ...
    //@}
        ...
        //! \cond HIDE_CLASS_METHODS
            ...
            CUniversalTLParams_Params_v6_1_0(CUniversalTLParams_Params_v6_1_0&);

            //! not implemented assignment operator
            CUniversalTLParams_Params_v6_1_0& operator=(CUniversalTLParams_Params_v6_1_0&);
    ...
    The \ref sample_ParametrizeCamera_NativeParameterAccess code sample shows how to access camera parameters via the \c Pylon::CBaslerUniversalInstantCamera class.
    */
    class CUniversalTLParams_Params : public CUniversalTLParams_Params_v6_1_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        //! \cond HIDE_CLASS_METHODS
            ...
            {
                CUniversalTLParams_Params_v6_1_0::_Initialize(pNodeMap);
            }
        //! \endcond            
    };
} // namespace Basler_UniversalTLParams
