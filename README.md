...
![SVTK image acquisition tab](https://github.com/i3drobotics/stereo-vision-toolkit/docs/github/images/svtk_screenshot.png "SVTK Screenshot showing acquisition tab.")
...
![SVTK matching an outdoor scene using SGM](https://github.com/i3drobotics/stereo-vision-toolkit/docs/github/images/svtk_screenshot_match.png "SVTK used to process an outdoor scene from a stereo video.")
