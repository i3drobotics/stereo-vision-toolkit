...
HRESULT createWaterMarkInjectorTopologyNode(
	IUnknown** aPtrPtrWaterMarkInjectorTopologyNode,
...
static const GUID MFMediaType_Video1 =
{ 0x73646976, 0x0000, 0x0010, { 0x80, 0x00, 0x00, 0xAA, 0x00, 0x38, 0x9B, 0x71 } };

static const GUID MFVideoFormat_RGB241 =
{ 20, 0x0000, 0x0010, { 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71 } };

static const GUID MFVideoFormat_RGB321 =
	...
	_In_ int       nCmdShow)
{
	...
	CComPtrCustom<IUnknown> lWaterMarkInjectorTopologyNode;


	lhresult = createWaterMarkInjectorTopologyNode(&lWaterMarkInjectorTopologyNode, lSampleGrabberCall);
	...
	lhresult = lSourceControl->createSourceNodeWithDownStreamConnection(
		...
		lIndexStream,
		lIndexMediaType,
		lWaterMarkInjectorTopologyNode,
		&lVideoSourceNode);
	...
	wc.lpszClassName = L"WaterMarkInjector";
	RegisterClass(&wc);

	/* create main window */
	hWnd = CreateWindow(
		L"WaterMarkInjector", L"WaterMarkInjector Sample",
	...
	IUnknown* aPtrDownstreamNode)
{
	...
	do
	{
		...
		lhresult = aNodeMFT->QueryInterface(IID_PPV_ARGS(aPtrPtrWaterMarkInjectorTopologyNode));
